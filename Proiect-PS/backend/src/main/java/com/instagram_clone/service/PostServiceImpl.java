...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public List<PostResponse> getPostsByRequester(String requesterUsername) {
        com.instagram_clone.entity.User requester = getRequesterUser(requesterUsername);
        return postRepository.findByUser_IdOrderByCreatedAtDesc(requester.getId())
                .stream()
                .map(this::mapToResponse)
                .toList();
    }
    ...
    private com.instagram_clone.entity.User getRequesterUser(String requesterUsername) {
        return userRepository.findByUsername(requesterUsername)
            .or(() -> userRepository.findByUsernameIgnoreCase(requesterUsername))
